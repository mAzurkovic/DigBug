 ...
 */
// [START write_fan_out]
function writeNewPost(uid, username, picture, title, body, price) {
  // A post entry.
  var postData = {
    author: username,
    uid: uid,
      ...
      '<div class="post post-' + postId + ' mdl-cell mdl-cell--12-col ' +
        ...
        '<div class="mdl-card mdl-shadow--2dp">' +
          '<div class="mdl-card__title mdl-color--light-blue-600 mdl-color-text--white">' +
            '<h4 class="mdl-card__title-text"></h4>' + '<h4 class="mdl-card__title-text" style="padding-left: 10px;"> $' + price + '</h4>' +
          '</div>' +
          '<div class="header">' +
            '<div>' +
          ...
          '<form class="add-comment" style="display: none;" action="#">' +
 ...
 */
function newPostForCurrentUser(title, text, price) {
...
window.addEventListener('load', function() {
  ...
  messageForm.onsubmit = function(e) {
    ...
    if (text && title) {
      newPostForCurrentUser(title, text, price).then(function() {
